  ...
  return zipFilter === null && providerFilter === null ?
    ...
    <div className='smallerCentered'>
      <b>Gov't:</b> <a href="https://covid-19-therapeutics-locator-dhhs.hub.arcgis.com/">Therapeutics Locator (HHS)</a> <b>Raw data:</b> <a href={baseUri + "data/therapeutics/"+constantsSite.siteLower+"/"+constantsSite.siteLower+"-providers.csv"}>CSV</a>, <a href="https://healthdata.gov/Health/COVID-19-Public-Therapeutic-Locator/rxn6-qnx8/data">healthdata.gov</a><br/>
        ...
        <b>Preventive Medicine:</b> <a href='https://vaccines.gov'>vaccine/boost</a>, <a href={'https://rrelyea.github.io/evusheld'+window.location.search}>evusheld</a> <b>Prevention:</b> <a href='https://www.cdc.gov/coronavirus/2019-ncov/testing/self-testing.html'>rapid tests (CDC)</a>, ventilation (<a href='https://www.epa.gov/coronavirus/ventilation-and-coronavirus-covid-19'>EPA</a>, <a href='https://www.cdc.gov/coronavirus/2019-ncov/community/ventilation.html'>CDC</a>), <a href='https://www.cdc.gov/coronavirus/2019-ncov/prevent-getting-sick/masks.html'>masking (CDC)</a> <b>Treatments:</b> <a href={'https://rrelyea.github.io/paxlovid'+window.location.search}>paxlovid</a>, <a href={'https://rrelyea.github.io/bebtelovimab'+window.location.search}>bebtelovimab</a>, <a href={'https://rrelyea.github.io/lagevrio'+window.location.search}>lagevrio</a>
    </div>
    </>
    : false;
}
...
function Footer() {
  return <>
    <div className='smallerFont'>&nbsp;</div>
    <div className='smallerCentered'>
      <b>Why:</b> <a href='https://www.geekwire.com/2022/after-wife-got-cancer-microsoft-engineer-built-a-tool-to-locate-anti-covid-drug-for-immunocompromised/'>why I built this site</a> <b>Contact Info:</b> <a href='https://twitter.com/rrelyea'>twitter</a>, <a href='https://linktr.ee/rrelyea'>email/more</a> <b>Sponsor:</b> <a href='https://buymeacoffee.com/rrelyea'>buymeacoffee.com/rrelyea</a>, <b>Programmers:</b> <a href={"https://github.com/rrelyea/"+constantsSite.site.toLowerCase()}>{'/'+ constantsSite.siteLower}</a>, <a href="https://github.com/rrelyea/covid-therapeutics">/covid-therapeutics</a>
    </div>
    <div className='smallerCentered'>&nbsp;</div>
  </>;
}
